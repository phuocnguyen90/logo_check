...
/home/phuoc/miniforge3/envs/torch12/bin/python scripts/data/00_create_toy_dataset.py --samples 10

# 01. Create Splits
echo "Step 01: Creating Stratified Splits for Toy Dataset..."
/home/phuoc/miniforge3/envs/torch12/bin/python scripts/data/01_run_eda.py --toy
...
/home/phuoc/miniforge3/envs/torch12/bin/python scripts/training/04_train_model_moco.py --toy

# 03. Build Index with Trained Model
echo "Step 03: Building Index with Trained Model..."
rm -rf indexes/embeddings/chunks/*
/home/phuoc/miniforge3/envs/torch12/bin/python scripts/indexing/03_build_index.py --toy --checkpoint models/checkpoints/latest.pth --workers 4
